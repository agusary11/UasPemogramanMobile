...
import Pencarian from '../komponen1/Pencarian';
import AkunKomponen from '../komponen1/Pencarian';
import VectorIcon from 'react-native-vector-icons/Ionicons'
import Icon from 'react-native-vector-icons/Feather'
import { createUser,editUser, listUser, removeUser } from './UserAkunService';
...
const UserAkun = () => {
    ...
    return (
        <View style={styles.container}>
            <Pencarian placeholder={'Search User. . .'} sortTitle={'FILTER'} />
            <FlatList
                data={users}
                renderItem={({ item: user }) => <AkunKomponen data={user} handleClicked={handleSelectedUser} handleDeleteUser={handleDeleteUser}/>}
                keyExtractor={({ id }) => id}
            />
